...
import { NavigationLinkType, footerNavigationLinks } from "../redux/reducers/navigationLinksSlice"
        ...
        <div className="col">
          <section>
            ...
            <ul className='nav flex-column'>
              {footerNavigationLinkList.map((link: NavigationLinkType, index: number) => {
